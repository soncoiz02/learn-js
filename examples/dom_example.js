...
//   let filterProucts = products;
//   Object.keys(filter).forEach((key) => {
//     if (filter[key]) {
//       filterProucts = filterProucts.filter((item) => {
//         if (key === "search") {
//           return item.name.toLowerCase().includes(filter[key].toLowerCase());
//         } else if (key === "star" || key === "price") {
...
//     }
//   });
//   console.log(filterProucts);
// };

// getProducts(filter);

// =======================================================
// Khởi tạo các từ khóa lọc
// Chuyển từ khóa lọc sang đối tượng
// Mỗi lần lọc theo từ khóa => update giá trị lọc => lấy lại object filter
// Lấy danh sách lọc dựa theo giá trị filter
